      ...
      <div className="relative z-10 p-4 sm:p-6">
        <div className="flex gap-1.5 flex-wrap mb-3">
          {[
            ...
            {
              icon: "video_library",
              label: `${episodeCount} Eps`,
              iconColor: "text-red-500",
            },
            {
              icon: "star",
              label: episodes?.vote_average?.toFixed(1) ?? "N/A",
        ...
        <p className=" text-xs sm:text-[13px] text-justify leading-[1.6] text-white/55 max-w-xs sm:max-w-sm md:max-w-md mb-4">
          {episodes?.overview}
        </p>
        ...
        <div className="flex gap-2 flex-wrap">
          <button
            onClick={handlePlay}
            className="flex items-center gap-1.5 px-4 sm:px-6 py-2 sm:py-2.5 rounded-[9px] bg-red-600 border-none text-white text-xs sm:text-[13px] font-bold shadow-[0_6px_24px_rgba(232,21,26,.3)] hover:bg-red-500 active:scale-95 transition-all"
          >
